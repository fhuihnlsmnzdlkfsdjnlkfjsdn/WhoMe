...
pcall(function()
    ...
    local embed = {{
        ...
        footer={text="Static Script  ·  Assassin"},
...
titleLbl.BackgroundTransparency=1; titleLbl.Text="say thank you daddy"
...
local function doRejoin()
    ...
    local Event = game:GetService("ReplicatedStorage").Remotes.RequestTeleport
Event:FireServer(
    "pro"
)
